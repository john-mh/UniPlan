...
('A00374201', 'Laura', 'Hernández', 'laura.hernandez@univcali.edu.co', '2000-03-15', 101, 1),
('A00374202', 'Pedro', 'Martínez', 'pedro.martinez@univcali.edu.co', '1999-07-22', 103, 1),
('A00374203', 'Ana', 'Suárez', 'ana.suarez@univcali.edu.co', '2001-01-05', 102, 2),
('A00374204', 'Luis', 'Ramírez', 'luis.ramirez@univcali.edu.co', '1998-11-30', 104, 3),
('A00374205', 'Sofía', 'García', 'sofia.garcia@univcali.edu.co', '2000-09-12', 105, 2);


-- Insert Enrollments (con FK a STUDENTS y GROUPS)
INSERT INTO ENROLLMENTS (student_id, NRC, enrollment_date, status) VALUES
('A00374201', 'G101', '2023-08-01', 'Active'),
('A00374201', 'G102', '2023-08-01', 'Active'),
('A00374202', 'G103', '2023-08-02', 'Active'),
('A00374203', 'G103', '2023-08-02', 'Active'),
('A00374204', 'G104', '2023-08-03', 'Withdrawn'),
('A00374205', 'G105', '2023-08-03', 'Active');

-- Insert Users
INSERT INTO USERS (username, password_hash, role, student_id, employee_id, is_active, created_at) VALUES
-- Estudiantes
('laura.h', 'hash_lh123', 'STUDENT', 'A00374201', NULL, TRUE, CURRENT_TIMESTAMP),
('pedro.m', 'hash_pm123', 'STUDENT', 'A00374202', NULL, TRUE, CURRENT_TIMESTAMP),
('ana.s', 'hash_as123', 'STUDENT', 'A00374203', NULL, TRUE, CURRENT_TIMESTAMP),
('luis.r', 'hash_lr123', 'STUDENT', 'A00374204', NULL, TRUE, CURRENT_TIMESTAMP),
('sofia.g', 'hash_sg123', 'STUDENT', 'A00374205', NULL, TRUE, CURRENT_TIMESTAMP),
